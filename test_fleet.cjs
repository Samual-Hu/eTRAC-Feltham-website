...
assert.equal(catalog.events.filter(e=>e.sourceFolder.endsWith('0904')).length,8);
...
assert.equal(vm.runInContext("sessions(filtered()).map(s=>s.primary.unit+' '+s.primary.date).sort().join(',')",ctx),'701030 2026-08-19,701046 2026-08-04,701046 2026-08-06');
assert.equal(vm.runInContext('savings(filtered()).count',ctx),2);
const covers=vm.runInContext("sessions(filtered()).filter(s=>s.primary.date!=='2026-08-04').map(s=>s.cover)",ctx);
